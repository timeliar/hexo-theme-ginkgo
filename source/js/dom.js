const $d = function(selector, element) {
...
$d.all = function(selector, element) {
  element = element || document;
  return element.querySelectorAll(selector)
};

$d.each = function(selector, callback, element) {
  return $d.all(selector, element).forEach(callback)
}
...
Object.assign(HTMLElement.prototype, {
  ...
  child: function(selector) {
    return $d(selector, this)
  },
  find: function(selector) {
    return $d.all(selector, this)
  },
